...
int add_vv_test_e8_m2()
{
    ...
    asm volatile (
        ...
        "vmv.x.s %0, v6\n\t"
        "vmv.x.s %1, v7\n\t"
        : "=r" (result0), "=r" (result1), : "r" (a) , "r" (b) ,  "r" (c), "r" (d)
    );

    if(result0 != (a+c) || result1 != (b+d))
    {
...
int add_vv_test_e8_m4(void)
{
    ...
    asm volatile (
        ...
        "vmv.x.s %2, v14\n\t"
        "vmv.x.s %3, v15\n\t"
        : "=r" (result0), "=r" (result1), "=r" (result2), "=r" (result3) : "r" (a), "r" (b), "r" (c), "r" (d), "r" (e), "r" (f), "r" (g), "r" (h)
    );

    if(result0 != (a+e) || result1 != (b+f) || result2 != (c+g) || result3 != (d+h))
    {
